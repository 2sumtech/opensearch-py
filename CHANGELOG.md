...
### Removed
### Fixed
- Fix `AsyncHttpConnection` raising `TransportError` subclasses with an unparsed JSON body and `info=None`, unlike every other connection class ([#1106](https://github.com/opensearch-project/opensearch-py/pull/1106))
